...
- [x] 首页动效方案评审，确认只增强公开页、不干扰工作台
- [x] 使用 CSS transition 增强基础交互
- [ ] 使用 GSAP 增强首页关键动效
- [x] 评估是否需要 ScrollTrigger
- [x] 移动端降低或禁用复杂动效
- [x] 检查动效不遮挡文字
- [x] 检查动效不影响首屏加载
- [x] 首页加载站点配置前使用骨架屏，不显示硬编码默认内容
- [x] 首页介绍详情滚动后不压住姓名标题，移动端邮箱居中
- [ ] 工作台保持克制、稳定、可扫描
- [x] 首页删除重复中部和底部导航
- [x] 首页新增个人介绍与技术栈展示
- [x] 首页改为固定首屏滚动进度动画，终端淡出、介绍居中放大并渐显详情
- [x] 增加全局语言切换入口，支持英文、中文、泰语，默认英文
- [x] 首页、登录页、工作台外壳、终端和总览接入全局语言
- [x] 管理页固定文案全部接入全局语言
...
2026-07-03:
- 首页改为固定首屏滚动进度动画，桌面与 390px 手机视口已验证无遮挡、无越界
2026-07-04:
- 首页移除硬编码站点默认值，改为加载骨架屏，避免姓名闪烁
- 首页删除中文“个人介绍”标签，调整介绍详情展开位置并优化移动端邮箱居中
```
