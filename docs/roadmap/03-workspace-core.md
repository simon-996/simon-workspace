...
当前状态：认证链路、RBAC 权限基础、权限管理、课程管理、班级管理、学期管理、模板管理、文件中心、生成记录查询和工作台主布局进行中，已有 Token 登录接口、角色/权限返回、用户角色分配、课程/班级/学期/模板/文件中心/生成记录前后端和响应式工作台壳层，学期周历支持生成后人工微调。最后核查时间：2026-07-02。
